...
from environment.Parallel_Machine import ENVIRONMENT
...
if __name__ == "__main__":
    ...
    process_all = ['BH', 'LH']
    priority = {'BH': [1, 2], 'LH': [1, 2, 3, 4, 5, 6, 7, 8]}
    ...
    env = ENVIRONMENT(weight=weight, job_type=job_type, machine_num=machine_num, process_time=p_ij,
                  process_list=process_list, process_all=process_all, priority=priority, IAT=IAT,
                  part_num=part_num, K=K)
